  ...
  ( SELECT
    ...
    ( SELECT
      ...
      ( SELECT                                                                  /* Modification section */
          ...
          'TIME' AGGREGATE_BY,        /* HOST, SERVICE, TIME, BACKUP_ID, BACKUP_TYPE, BACKUP_DATA_TYPE, STATE, MESSAGE, CONF_INCLUDED or comma separated list, NONE for no aggregation */
