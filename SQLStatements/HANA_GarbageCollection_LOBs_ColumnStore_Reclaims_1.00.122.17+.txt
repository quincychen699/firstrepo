...
- Statistics server history HOST_CS_LOB_SPACE_RECLAIMS also exists, but with a significantly different format,
  so it can hardly be considered in a good way (bug 308767)
