...
- HANA_Global_TimeFrameReport_2.00.043+
...
( SELECT
  ...
  ( SELECT
    ...
    ( SELECT
        ...
        SUM(S.TOTAL_LOCK_WAIT_DURATION) / 1000000 LOCK_S,
...
( SELECT
  ...
  WHERE
    DU.SERVER_TIMESTAMP BETWEEN BI.BEGIN_TIME AND BI.END_TIME
  GROUP BY
    DU.HOST
),
  ...
  ( SELECT
    ...
    ( SELECT
      ...
      ( SELECT
          ...
          SCHEMA_NAME,
          TABLE_NAME,
          SUM(INDEX_SIZE / 1024 / 1024 / 1024) RS_IND_SIZE_GB
        FROM
          _SYS_STATISTICS.HOST_RS_INDEXES
        GROUP BY
          HOST,
          SCHEMA_NAME,
          TABLE_NAME,
...
( SELECT
  ...
  ( SELECT
    ...
    ( SELECT
      ...
      WHERE
        P.SERVER_TIMESTAMP BETWEEN BI.BEGIN_TIME AND BI.END_TIME
      GROUP BY
        P.SCHEMA_NAME,
        P.TABLE_NAME,
        BI.TOP_N_DISK
  ...
  ( SELECT
    ...
    FROM
     BASIS_INFO BI,
       _SYS_STATISTICS.HOST_DELTA_MERGE_STATISTICS M
    WHERE
      M.START_TIME BETWEEN BI.BEGIN_TIME AND BI.END_TIME
    GROUP BY
      M.SCHEMA_NAME,
      M.TABLE_NAME,
      M.TYPE,
...
UNION ALL SELECT 70060, RPAD('STATEMENT_HASH', 32) || CHAR(32) || RPAD('TP', 2) || CHAR(32) || LPAD('ELAPSED_S', 11) || CHAR(32) || LPAD('PER_EXEC_MS', 11) || CHAR(32) ||
  LPAD('ACT_SESS', 8) || CHAR(32) || LPAD('EXECUTIONS', 11) || CHAR(32) || LPAD('RECORDS', 12) || CHAR(32) || LPAD('REC_PER_EXEC', 12) || CHAR(32) || 
  LPAD('LOCK_S', 6) || CHAR(32) || 'ACCESSED_OBJECTS' FROM DUMMY
UNION ALL SELECT 70070, RPAD('=', 32, '=') || CHAR(32) || RPAD('==', 2) || CHAR(32) || LPAD('=', 11, '=') || CHAR(32) || LPAD('=', 11, '=') || CHAR(32) || 
  LPAD('=', 8, '=') || CHAR(32) || LPAD('=', 11, '=') || CHAR(32) || LPAD('=', 12, '=') || CHAR(32) || LPAD('=', 12, '=') || CHAR(32) || 
  LPAD('=', 6, '=') || CHAR(32) || LPAD('=', 95, '=') FROM DUMMY
UNION ALL
SELECT
  70100 + LN / 1000, RPAD(STATEMENT_HASH, 32) || CHAR(32) || RPAD(SQL_TYPE, 2) || CHAR(32) || LPAD(ELAPSED_S, 11) || CHAR(32) || LPAD(ELA_PER_EXEC_MS, 11) || CHAR(32) ||
  LPAD(ACT_SESS, 8) || CHAR(32) || LPAD(EXECUTIONS, 11) || CHAR(32) || LPAD(RECORDS, 12) || CHAR(32) || LPAD(REC_PER_EXEC, 12) || CHAR(32) || 
    LPAD(LOCK_S, 6) || CHAR(32) || RPAD(ACCESSED_OBJECTS, 95)
FROM
( SELECT
    ...
    TO_DECIMAL(ROUND(S.LOCK_S), 10, 0) LOCK_S,
