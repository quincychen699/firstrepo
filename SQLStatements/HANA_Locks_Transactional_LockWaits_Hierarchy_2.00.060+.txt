...
- HANA_Locks_Transactional_LockWaits_Hierarchy_2.00.060+
...
- 2022/10/02:  1.9 (redesign using SQL hierarchies)
...
- LM:              Lock mode ('E' -> EXCLUSIVE, 'IE' -> INTENTIONAL EXCLUSIVE, 'NKE' -> NON_KEY_EXCLUSIVE, 'S' -> SHARED)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|2017/03/10 10:08:05|465456    | 4641526537|       |R |E | |SAPERP|LAGP       |saphana2 / 14438|/GLB/SAPLUGTPT_WM_INT_CONTROL:69 |                                |                                             |
...
|2017/03/10 10:08:05|452764    | 4641535448|       |R |E | |SAPERP|LAGP       |saphana4 / 9937 |/EUR/SAPLUEUPT_PRINTER_DETERM:914|                                |                                             |
...
|2017/03/10 10:08:05|402958    | 4641563249|       |R |E | |SAPERP|LAGP       |saphana2 / 31923|/GLB/SAPLUGTPT_TB_EMPTY_TOTE:806 |                                |                                             |
|                   |  455307  | 4641462162|      1|R |E | |SAPERP|LAGP       |saphana9 / 12460|SAPLL03T:18810                   |e940387338ef56106c040dea88495d01|OID=0x00017B72, PARTID=0x0, OFFSET=0x1E2AF78E|
...
( SELECT
  ...
  ( SELECT                            /* Modification section */
      'C-H12' BEGIN_TIME,                  /* YYYY/MM/DD HH24:MI:SS timestamp, C, C-S<seconds>, C-M<minutes>, C-H<hours>, C-D<days>, C-W<weeks>, E-S<seconds>, E-M<minutes>, E-H<hours>, E-D<days>, E-W<weeks>, MIN */
...
( SELECT
  ...
  WHERE
    ...
    ( BI.SITE_ID = -1 OR ( BI.SITE_ID = 0 AND BT.SITE_ID IN (-1, 0) ) OR BT.SITE_ID = BI.SITE_ID ) AND    BT.HOST LIKE BI.HOST AND
...
SELECT
  ...
  LPAD(BLOCKED_UPDATE_TRANSACTION_ID, 11) UTID,
