...
- HANA_Memory_Components_2.00.060+
...
- With SAP HANA 2.00.070 - 2.00.073 M_SERVICE_MEMORY may also contain information about secondary system replication sites, but no SITE_ID column.
  Thus the SITE_ID information for DATA_SOURCE = 'CURRENT' can be wrong. With SAP HANA >= 2.00.074 only services of the primary site are shown.
  ...
  ( SELECT    
    ...
    ( SELECT
      ...
      ( SELECT                                                      /* Modification section */
          ...
          'NONE' AGGREGATE_BY,              /* TIME, SITE_ID, HOST, PORT or comma separated combinations, NONE for no aggregation */
