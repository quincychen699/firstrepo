  ...
  ( SELECT
    ...
    ( SELECT
      ...
      ( SELECT                            /* Modification section */
          ...
          'TIME, SENDER_HOST, SENDER_PORT' AGGREGATE_BY,            /* TIME, SENDER_HOST, SENDER_PORT, RECEIVER_HOST, RECEIVER_PORT or comma-separated combination, NONE for no aggregation */
