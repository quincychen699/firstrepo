...
- 2024/07/15:  1.1 (IS_DETERMINISTIC included)
...
- IS_DETERMINISTIC
  ...
  Flag for deterministic functions

  'TRUE'          --> Only display deterministic functions
  'FALSE'         --> Only display non-deterministic functions
  '%'             --> No restriction related to deterministic functions
...
- DETERMINISTIC: TRUE of function is deterministic, otherwise FALSE
...
*/
  ...
  F.IS_VALID VALID,
  F.IS_DETERMINISTIC DETERMINISTIC,
...
WHERE
  ...
  F.IS_DETERMINISTIC LIKE BI.IS_DETERMINISTIC AND
