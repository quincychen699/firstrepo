...
- HANA_Replication_SystemReplication_KeyFigures_2.00.020+
...
*/
  ...
  LPAD(TO_DECIMAL(GREATEST(ROUND(REPLAY_DELAY_S), 0), 10, 0), 9) REP_DL_S,
  LPAD(TO_DECIMAL(GREATEST(ROUND(REPLAY_BACKLOG_MB), 0), 10, 0), 9) REP_BL_MB,
  REP_STATUS,
  ...
  ( SELECT
    ...
    SECONDARY_HOST,
      ...
      ( SELECT                                                     /* Modification section */
          ...
          'NONE' AGGREGATE_BY,         /* HOST, SECONDARY_HOST, PORT, TIME, STATUS, MODE or comma separated combinations, NONE for no aggregation */
