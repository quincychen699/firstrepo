...
- HANA_StatisticsServer_Histories_RetentionTime_2.00.073+
...
- New histories with SAP HANA 2.00.056:

  - HOST_PERSISTENT_MEMORY_VOLUMES
  - HOST_PERSISTENT_MEMORY_VOLUME_STATISTICS

- New histories with SAP HANA 2.00.060:

  - HOST_JOBEXECUTOR_WORKER_GROUPS

- New histories with SAP HANA 2.00.062:

  - HOST_BUFFER_CACHE_POOL_STATISTICS
  - HOST_BUFFER_CACHE_STATISTICS

- New histories with SAP HANA 2.00.070:

  - HOST_CS_TABLE_HANDLES

- New histories with SAP HANA 2.00.073:
...
- 2021/06/25:  1.8 (dedicated 2.00.056+ version)
- 2024/03/12:  1.9 (dedicated 2.00.073+ version)
...
*/
  ...
  IFNULL(LPAD(MAP(TABLE_NAME,
    ...
    'HOST_BUFFER_CACHE_POOL_STATISTICS',        HOST_BUFFER_CACHE_POOL_STATISTICS_DAYS,
    'HOST_BUFFER_CACHE_STATISTICS',             HOST_BUFFER_CACHE_STATISTICS_DAYS,
    ...
    'HOST_CS_LOB_SPACE_RECLAIM_DETAILS',        HOST_CS_LOB_SPACE_RECLAIM_DETAILS_DAYS,
    'HOST_CS_TABLE_HANDLES',                    HOST_CS_TABLE_HANDLES_DAYS,
    ...
    'HOST_JOBEXECUTOR_WORKER_GROUPS',           HOST_JOBEXECUTOR_WORKER_GROUPS_DAYS,
    ...
    'HOST_PERSISTENT_MEMORY_VOLUMES',           HOST_PERSISTENT_MEMORY_VOLUMES_DAYS,
    'HOST_PERSISTENT_MEMORY_VOLUME_STATISTICS', HOST_PERSISTENT_MEMORY_VOLUME_STATISTICS_DAYS,
...
( SELECT
    ...
    ( SELECT DAYS_BETWEEN(MIN(SERVER_TIMESTAMP), CURRENT_TIMESTAMP) FROM _SYS_STATISTICS.HOST_BUFFER_CACHE_POOL_STATISTICS )        HOST_BUFFER_CACHE_POOL_STATISTICS_DAYS,
    ( SELECT DAYS_BETWEEN(MIN(SERVER_TIMESTAMP), CURRENT_TIMESTAMP) FROM _SYS_STATISTICS.HOST_BUFFER_CACHE_STATISTICS )             HOST_BUFFER_CACHE_STATISTICS_DAYS,
    ...
    ( SELECT DAYS_BETWEEN(MIN(SERVER_TIMESTAMP), CURRENT_TIMESTAMP) FROM _SYS_STATISTICS.HOST_CS_LOB_SPACE_RECLAIM_DETAILS )        HOST_CS_LOB_SPACE_RECLAIM_DETAILS_DAYS,
    ( SELECT DAYS_BETWEEN(MIN(SERVER_TIMESTAMP), CURRENT_TIMESTAMP) FROM _SYS_STATISTICS.HOST_CS_TABLE_HANDLES )                    HOST_CS_TABLE_HANDLES_DAYS,
    ...
    ( SELECT DAYS_BETWEEN(MIN(SERVER_TIMESTAMP), CURRENT_TIMESTAMP) FROM _SYS_STATISTICS.HOST_JOBEXECUTOR_WORKER_GROUPS )           HOST_JOBEXECUTOR_WORKER_GROUPS_DAYS,
    ...
    ( SELECT DAYS_BETWEEN(MIN(SERVER_TIMESTAMP), CURRENT_TIMESTAMP) FROM _SYS_STATISTICS.HOST_PERSISTENT_MEMORY_VOLUMES )           HOST_PERSISTENT_MEMORY_VOLUMES_DAYS,
    ( SELECT DAYS_BETWEEN(MIN(SERVER_TIMESTAMP), CURRENT_TIMESTAMP) FROM _SYS_STATISTICS.HOST_PERSISTENT_MEMORY_VOLUME_STATISTICS ) HOST_PERSISTENT_MEMORY_VOLUME_STATISTICS_DAYS,
